...
class Ludo:
    def __init__(self, root,six_side_block,five_side_block,four_side_block,three_side_block,two_side_block,one_side_block):
        ...
        self.make_canvas = Canvas(self.window, bg="plum", width=1000, height=1000)
    ...
    def board_set_up(self):
        ...
        self.make_canvas.create_rectangle(100, (15+240)+(40*3), 100+240, (15+240)+(40*3)+(40*6), width=3, fill="#0411ff")# left down large square
        self.make_canvas.create_rectangle(340+(40*3), 15, 340+(40*3)+(40*6), 15+240, width=3, fill="olivedrab")# right up large square
        ...
        self.make_canvas.create_rectangle(100+240+40, 15+40, 100+240+80, 15 + (40*6), width=3, fill="olivedrab")
        ...
        self.make_canvas.create_rectangle(100+240+40, (15 + 240)+(40*3), 100 + 240+40+40, (15 + 240)+(40*3)+(40*6)-40, width=3, fill="#0411ff")
        ...
        self.make_canvas.create_rectangle(340+(40*3)+40, 15 + 40, 340+(40*3)+40 + 40, 15 + 40 + 40, width=3, fill="olivedrab")
        self.make_canvas.create_rectangle(340+(40*3)+40+ 60 + 40+20, 15 + 40, 340+(40*3)+40 + 60 + 40 + 40+20, 15 + 40 + 40, width=3, fill="olivedrab")
        self.make_canvas.create_rectangle(340+(40*3)+40, 15 + 40 + 100, 340+(40*3)+40 + 40, 15 + 40 + 40 + 100, width=3, fill="olivedrab")
        self.make_canvas.create_rectangle(340+(40*3)+40+ 60 + 40+20, 15 + 40 + 100, 340+(40*3)+40 + 60 + 40 + 40+20, 15 + 40 + 40 + 100, width=3, fill="olivedrab")


        # Left down square inside box made
        self.make_canvas.create_rectangle(100 + 40, 340+80+15, 100 + 40 + 40, 340+80+40+15, width=3, fill="#0411ff")
        self.make_canvas.create_rectangle(100 + 40 + 60 + 40+20, 340+80+15, 100 + 40 + 60 + 40 + 40+20, 340+80+40+15, width=3, fill="#0411ff")
        self.make_canvas.create_rectangle(100 + 40, 340+80+60+40+15, 100 + 40 + 40, 340+80+60+40+40+15, width=3, fill="#0411ff")
        self.make_canvas.create_rectangle(100 + 40 + 60 + 40+20, 340+80+60+40+15, 100 + 40 + 60 + 40 + 40+20, 340+80+60+40+40+15, width=3, fill="#0411ff")
        ...
        self.make_canvas.create_rectangle(100+240,340+(40*5)-5,100+240+40,340+(40*6)-5,fill="#0411ff",width=3)
        # Red start position
        self.make_canvas.create_rectangle(100 + 40, 15+(40*6), 100 +40 + 40, 15+(40*6)+40, fill="red", width=3)
        # Green start position
        self.make_canvas.create_rectangle(100 + (40*8), 15 + 40, 100 +(40*9), 15 + 40+ 40, fill="olivedrab", width=3)
        ...
        self.make_canvas.create_polygon(100 + 240, 15 + 240, 100 + 240 + 60, 15 + 240 + 60, 100 + 240 + (40 * 3), 15 + 240, width=3, fill="olivedrab",outline="black")
        self.make_canvas.create_polygon(100 + 240, 15 + 240+(40*3), 100 + 240 + 60, 15 + 240 + 60, 100 + 240 + (40 * 3), 15 + 240+(40*3), width=3, fill="#0411ff",outline="black")
        ...
        green_1_coin = self.make_canvas.create_oval(340+(40*3)+40, 15 + 40, 340+(40*3)+40 + 40, 15 + 40 + 40, width=3, fill="olivedrab", outline="black")
        green_2_coin = self.make_canvas.create_oval(340+(40*3)+40+ 60 + 40+20, 15 + 40, 340+(40*3)+40 + 60 + 40 + 40+20, 15 + 40 + 40, width=3, fill="olivedrab", outline="black")
        green_3_coin = self.make_canvas.create_oval(340 + (40 * 3) + 40 + 60 + 40 + 20, 15 + 40 + 100, 340 + (40 * 3) + 40 + 60 + 40 + 40 + 20, 15 + 40 + 40 + 100, width=3, fill="olivedrab", outline="black")
        green_4_coin = self.make_canvas.create_oval(340+(40*3)+40, 15 + 40 + 100, 340+(40*3)+40 + 40, 15 + 40 + 40 + 100, width=3, fill="olivedrab", outline="black")
        ...
        green_1_label = Label(self.make_canvas, text="1", font=("Arial", 15, "bold"), bg="olivedrab", fg="black")
        green_1_label.place(x=340 + (40 * 3) + 40 + 10, y=15 + 40 + 5)
        green_2_label = Label(self.make_canvas, text="2", font=("Arial", 15, "bold"), bg="olivedrab", fg="black")
        green_2_label.place(x=340 + (40 * 3) + 40 + 40 + 60 + 30, y=15 + 40 + 5)
        green_3_label = Label(self.make_canvas, text="3", font=("Arial", 15, "bold"), bg="olivedrab", fg="black")
        green_3_label.place(x=340 + (40 * 3) + 40 + 40 + 60 + 30, y=15 + 40 + 100 + 5)
        green_4_label = Label(self.make_canvas, text="4", font=("Arial", 15, "bold"), bg="olivedrab", fg="black")
        ...
        sky_blue_1_coin = self.make_canvas.create_oval(100 + 40, 340+80+15, 100 + 40 + 40, 340+80+40+15, width=3, fill="#0411ff", outline="black")
        sky_blue_2_coin = self.make_canvas.create_oval(100 + 40 + 60 + 40+20, 340+80+15, 100 + 40 + 60 + 40 + 40+20, 340+80+40+15, width=3, fill="#0411ff", outline="black")
        sky_blue_3_coin = self.make_canvas.create_oval(100 + 40 + 60 + 40 + 20, 340 + 80 + 60 + 40 + 15, 100 + 40 + 60 + 40 + 40 + 20, 340 + 80 + 60 + 40 + 40 + 15, width=3, fill="#0411ff", outline="black")
        sky_blue_4_coin = self.make_canvas.create_oval( 100 + 40, 340+80+60+40+15, 100 + 40 + 40, 340+80+60+40+40+15, width=3, fill="#0411ff", outline="black")
        ...
        sky_blue_1_label = Label(self.make_canvas, text="1", font=("Arial", 15, "bold"), bg="#0411ff", fg="black")
        sky_blue_1_label.place(x=100 + 40 + 10, y=30 + (40 * 6) + (40 * 3) + 40 + 10)
        sky_blue_2_label = Label(self.make_canvas, text="2", font=("Arial", 15, "bold"), bg="#0411ff", fg="black")
        sky_blue_2_label.place(x=100 + 40 + 60 + 60 + 10, y=30 + (40 * 6) + (40 * 3) + 40 + 10)
        sky_blue_3_label = Label(self.make_canvas, text="3", font=("Arial", 15, "bold"), bg="#0411ff", fg="black")
        sky_blue_3_label.place(x=100 + 40 + 60 + 60 + 10, y=30 + (40 * 6) + (40 * 3) + 40 + 60 + 40 + 10)
        sky_blue_4_label = Label(self.make_canvas, text="4", font=("Arial", 15, "bold"), bg="#0411ff", fg="black")
        ...
        self.make_canvas.create_polygon(coord,width=3,fill="yellow")
        ...
        #              A                              B                                   C                             D                                E                                        F                       G                                          H                               I                            J                                      K                                   L
        coord = [common_x, common_y,   common_x + 5,   common_y + 15,      common_x + 15, common_y + 15,      common_x + 8, common_y + 20,     common_x + 15, common_y + 25,       common_x + 5, common_y + 25,      common_x, common_y + 25 + 10,    common_x - 5, common_y + 25,     common_x - 16, common_y + 25,     common_x - 8,common_y + 15 + 5,     common_x - 15,common_y + 15,     common_x - 5,common_y + 15]
        self.make_canvas.create_polygon(coord, width=3, fill="olivedrab")
        ...
        #                  A                     B                                   C                            D                                 E                                F                           G                                  H                                    I                                 J                                    K                                L
        coord = [common_x, common_y,   common_x + 5, common_y + 15,    common_x + 15, common_y + 15,    common_x + 8,common_y + 20,    common_x + 15, common_y + 25,    common_x + 5, common_y + 25,    common_x, common_y + 25 + 10,    common_x - 5, common_y + 25,      common_x - 16, common_y + 25,     common_x - 8, common_y + 15 + 5,     common_x - 15, common_y + 15,     common_x - 5, common_y + 15]
        self.make_canvas.create_polygon(coord, width=3, fill="red")
        ...
        #              A                         B                             C                                       D                        E                                       F                                   G                                     H                                  I                                  J                                  K                                  L
        coord = [common_x, common_y,   common_x + 5, common_y + 15,    common_x + 15, common_y + 15,    common_x + 8, common_y + 20,    common_x + 15, common_y + 25,      common_x + 5, common_y + 25,       common_x, common_y + 25 + 10,        common_x - 5, common_y + 25,       common_x - 16, common_y + 25,       common_x - 8, common_y + 15 + 5,      common_x - 15, common_y + 15,      common_x - 5, common_y + 15]
        self.make_canvas.create_polygon(coord, width=3, fill="#0411ff")
    ...
    def take_initial_control(self):
        ...
        #start.maxsize(600,500)
        #start.minsize(600,500)
        #start.config(bg="red")
        #head=Label(start,text='Start',font=('Arial',30,"bold"),bg="red",fg="black")
        ...
        top.maxsize(600,500)
        top.minsize(600,500)
        top.config(bg="palevioletred")
       
        top.iconbitmap('C:\\Users\\lenovo\\OneDrive\\Desktop\\ludo\\ludo_icon.ico')

        head = Label(top,text="-:Total number of players:- ",font=("Arial",25,"bold","italic"),bg="palevioletred",fg="firebrick")
    ...
    def make_prediction(self,color_indicator):
        try:
            if color_indicator == "red":
                ...
                #dice=AudioSegment.from_mp3("C:\\Users\\lenovo\\OneDrive\\Desktop\\ludo\\rolling-dice-2-102706.mp3")
                #play(dice)
                ...
                #playsound("C:\\Users\\sathwik\\Downloads\\rolling-dice-2-102706.mp3")
                #dice=AudioSegment.from_mp3("C:\\Users\\lenovo\\OneDrive\\Desktop\\ludo\\rolling-dice-2-102706.mp3")
                #play(dice)
            ...
            #playsound("C:\\Users\\Delll\\Downloads\\MANYDICE.wav")
    ...
    def instruction_btn_red(self):
        ...
        predict_red = Button(self.make_canvas, bg="black", fg="olivedrab", relief=RAISED, bd=5, text="Predict", font=("Arial", 8, "bold"), command=lambda: self.make_prediction("red"))
        ...
        final_move = Button(self.make_canvas,bg="black",fg="olivedrab",relief=RAISED,bd=5,text="Give",font=("Arial",8,"bold"),command=lambda: self.main_controller("red",entry_take_red.get()),state=DISABLED)
    ...
    def instruction_btn_sky_blue(self):
        ...
        predict_sky_blue = Button(self.make_canvas, bg="black", fg="olivedrab", relief=RAISED, bd=5, text="Predict",font=("Arial", 8, "bold"), command=lambda: self.make_prediction("sky_blue"))
        ...
        final_move = Button(self.make_canvas, bg="black", fg="olivedrab", relief=RAISED, bd=5, text="Give", font=("Arial", 8, "bold"),command=lambda: self.main_controller("sky_blue",entry_take_sky_blue.get()),state=DISABLED)
    ...
    def instruction_btn_yellow(self):
        ...
        predict_yellow = Button(self.make_canvas, bg="black", fg="olivedrab", relief=RAISED, bd=5, text="Predict",font=("Arial", 8, "bold"), command=lambda: self.make_prediction("yellow"))
        ...
        final_move = Button(self.make_canvas, bg="black", fg="olivedrab", relief=RAISED, bd=5, text="Give",font=("Arial", 8, "bold"),command=lambda: self.main_controller("yellow",entry_take_yellow.get()),state=DISABLED)
        final_move.place(x=100 + (40 * 6 + 40 * 3 + 40 * 6 + 2)+17, y=15 + (40 * 6 + 40 * 3) + 40 + 110)
        Label(self.make_canvas, text="Player 3", bg="#411dff", fg="gold", font=("Arial", 15, "bold")).place(x=100 + (40 * 6 + 40 * 3 + 40 * 6 + 3),y=15 + (40 * 6 + 40 * 3) + 40 + 110 + 40)
    ...
    def instruction_btn_green(self):
        ...
        predict_green = Button(self.make_canvas, bg="black", fg="olivedrab", relief=RAISED, bd=5, text="Predict", font=("Arial", 8, "bold"), command=lambda: self.make_prediction("green"))
        ...
        final_move = Button(self.make_canvas, bg="black", fg="olivedrab", relief=RAISED, bd=5, text="Give",font=("Arial", 8, "bold"),command=lambda: self.main_controller("green",entry_take_green.get()),state=DISABLED)
    ...
    def green_circle_start_position(self,coin_number):
        ...
        self.made_green_coin[int(coin_number)-1] = self.make_canvas.create_oval(100 + (40*8), 15 + 40, 100 +(40*9), 15 + 40+ 40, fill="olivedrab", width=3)
    ...
    def sky_blue_circle_start_position(self,coin_number):
        ...
        self.made_sky_blue_coin[int(coin_number)-1] = self.make_canvas.create_oval(100+240,340+(40*5)-5,100+240+40,340+(40*6)-5,fill="#0411ff",width=3)
    ...
    def main_controller(self, color_coin, coin_number):
        ...
        if  color_coin == "red":
            ...
            if self.move_red_counter == 106:
                ...
                #portaudio=pyaudio.PyAudio("C:\\Users\\sathwik\\Downloads\\mixkit-arcade-retro-changing-tab-206.wav")
            ...
            #coin_movement=pygame.mixer.Sound("C:\\Users\\Delll\\Downloads\\mixkit-winning-a-coin-video-game-2069.wav")
            #coin_movement.play()
    ...
    def motion_of_coin(self,counter_coin,specific_coin,number_label,number_label_x ,number_label_y,color_coin,path_counter):
        ...
        while True:
            if path_counter == 0:
                ...
                if  counter_coin == 106:
                    #coin_at_home=pygame.mixer.Sound("C:\\Users\\Delll\\Downloads\\mixkit-achievement-completed-2068.wav")
                    #coin_at_home.play()
        ...
        if  color_coin!="red":
            for take_coin_number in range(len(self.red_coord_store)):
                if  self.red_coord_store[take_coin_number] == counter_coin:
                    ...
                    #coin_kill=pygame.mixer.Sound("C:\\Users\\Delll\\Downloads\\cartoon-jump-6462.mp3")
                    #coin_kill.play()
                    messagebox.showinfo("coin overlapped"," red coin is killed")
        ...
        if  color_coin != "green":
            for take_coin_number in range(len(self.green_coord_store)):
                if  self.green_coord_store[take_coin_number] == counter_coin:
                    ...
                    #coin_kill=pygame.mixer.Sound("C:\\Users\\Delll\\Downloads\\cartoon-jump-6462.mp3")
                    #coin_kill.play()
                    messagebox.showinfo("coin overlapped"," green coin is killed")

                    if take_coin_number == 0:
                        remade_coin = self.make_canvas.create_oval(340+(40*3)+40, 15 + 40, 340+(40*3)+40 + 40, 15 + 40 + 40, width=3, fill="olivedrab", outline="black")
                        self.green_number_label[take_coin_number].place(x=340 + (40 * 3) + 40 + 10, y=15 + 40 + 5)
                    elif take_coin_number == 1:
                        remade_coin = self.make_canvas.create_oval(340+(40*3)+40+ 60 + 40+20, 15 + 40, 340+(40*3)+40 + 60 + 40 + 40+20, 15 + 40 + 40, width=3, fill="olivedrab", outline="black")
                        self.green_number_label[take_coin_number].place(x=340 + (40 * 3) + 40 + 40 + 60 + 30, y=15 + 40 + 5)
                    elif take_coin_number == 2:
                        remade_coin = self.make_canvas.create_oval(340 + (40 * 3) + 40 + 60 + 40 + 20, 15 + 40 + 100, 340 + (40 * 3) + 40 + 60 + 40 + 40 + 20, 15 + 40 + 40 + 100, width=3, fill="olivedrab", outline="black")
                        self.green_number_label[take_coin_number].place(x=340 + (40 * 3) + 40 + 40 + 60 + 30, y=15 + 40 + 100 + 5)
                    else:
                        remade_coin = self.make_canvas.create_oval(340+(40*3)+40, 15 + 40 + 100, 340+(40*3)+40 + 40, 15 + 40 + 40 + 100, width=3, fill="olivedrab", outline="black")
        ...
        if  color_coin != "yellow":
            for take_coin_number in range(len(self.yellow_coord_store)):
                if  self.yellow_coord_store[take_coin_number] == counter_coin:
                    ...
                    #coin_kill=pygame.mixer.Sound("C:\\Users\\Delll\\Downloads\\cartoon-jump-6462.mp3")
                    #coin_kill.play()
                    messagebox.showinfo("coin overlapped","yellow coin is killed")
        ...
        if  color_coin != "sky_blue":
            for take_coin_number in range(len(self.sky_blue_coord_store)):
                if  self.sky_blue_coord_store[take_coin_number] == counter_coin:
                   ...
                   # coin_kill=pygame.mixer.Sound("C:\\Users\\Delll\\Downloads\\cartoon-jump-6462.mp3")
                    #coin_kill.play()
                    messagebox.showinfo("coin overlapped"," blue coin is killed")

                    if take_coin_number == 0:
                        remade_coin = self.make_canvas.create_oval(100 + 40, 340+80+15, 100 + 40 + 40, 340+80+40+15, width=3, fill="#0411ff", outline="black")
                        self.sky_blue_number_label[take_coin_number].place(x=100+40+10, y=30 + (40*6)+(40*3)+40+10)
                    elif take_coin_number == 1:
                        remade_coin = self.make_canvas.create_oval(100 + 40 + 60 + 40+20, 340+80+15, 100 + 40 + 60 + 40 + 40+20, 340+80+40+15, width=3, fill="#0411ff", outline="black")
                        self.sky_blue_number_label[take_coin_number].place(x=100 + 40 + 60 +60 + 10, y=30 + (40*6)+(40*3)+40+10)
                    elif take_coin_number == 2:
                        remade_coin = self.make_canvas.create_oval(100 + 40 + 60 + 40 + 20, 340 + 80 + 60 + 40 + 15, 100 + 40 + 60 + 40 + 40 + 20, 340 + 80 + 60 + 40 + 40 + 15, width=3, fill="#0411ff", outline="black")
                        self.sky_blue_number_label[take_coin_number].place(x=100 + 40 + 60 + 60 + 10, y=30 + (40 * 6) + (40 * 3) + 40 + 60 + 40 + 10)
                    else:
                        remade_coin = self.make_canvas.create_oval( 100 + 40, 340+80+60+40+15, 100 + 40 + 40, 340+80+60+40+40+15, width=3, fill="#0411ff", outline="black")
    ...
    def under_room_traversal_control(self,specific_coin,number_label,number_label_x,number_label_y,path_counter,counter_coin,color_coin):
        if color_coin == "red" and counter_coin >= 100:
            if int(counter_coin)+int(path_counter)<=106:
               ...
               #home_sound=pygame.mixer.Sound("C:\\Users\\sathwik\\Downloads\\mixkit-arcade-retro-changing-tab-206.wav")
    ...
    def check_winner_and_runner(self,color_coin):
        ...
        if  destination_reached == 1:# If all coins in block reach to the destination, winner and runner check
            ...
            if self.take_permission == 1:# Winner check
                #winning=pygame.mixer.Sound("C:\\Users\\Delll\\Downloads\\success-fanfare-trumpets-6185.mp3")
                #winning.play()
...
if __name__ == '__main__':
    ...
    window.iconbitmap("C:\\Users\\lenovo\\OneDrive\\Desktop\\ludo\\ludo_icon.ico")
    block_six_side = ImageTk.PhotoImage(Image.open("C:\\Users\\lenovo\\OneDrive\\Desktop\\ludo\\6_block.png").resize((33, 33),Image.Resampling.LANCZOS))
    block_five_side = ImageTk.PhotoImage(Image.open("C:\\Users\\lenovo\\OneDrive\\Desktop\\ludo\\5_block.png").resize((33, 33),Image.Resampling.LANCZOS))
    block_four_side = ImageTk.PhotoImage(Image.open("C:\\Users\\lenovo\\OneDrive\\Desktop\\ludo\\4_block.png").resize((33, 33),Image.Resampling.LANCZOS))
    block_three_side = ImageTk.PhotoImage(Image.open("C:\\Users\\lenovo\\OneDrive\\Desktop\\ludo\\3_block.png").resize((33, 33),Image. Resampling.LANCZOS))
    block_two_side = ImageTk.PhotoImage(Image.open("C:\\Users\\lenovo\\OneDrive\\Desktop\\ludo\\2_block.png").resize((33, 33),Image.Resampling.LANCZOS))
    block_one_side = ImageTk.PhotoImage(Image.open("C:\\Users\\lenovo\\OneDrive\\Desktop\\ludo\\1_block.png").resize((33, 33),Image.Resampling.LANCZOS))

    ludo = Ludo(window,block_six_side,block_five_side,block_four_side,block_three_side,block_two_side,block_one_side)
