...
Console mode – a text-based interface showing dice rolls, moves, and board updates.
GUI mode (optional) – built using Tkinter or Pygame for an interactive graphical experience.
  This project demonstrates:
  Logical thinking and algorithmic design
  Use of classes and data structures for game management
Event handling and user interaction (in GUI version)
It’s a fun, educational project for practicing Python programming while recreating a classic board game experience!
Tech Stack:
Python 3
